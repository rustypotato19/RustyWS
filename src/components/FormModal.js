...
const FormModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      {/* Modal */}
      <div
        className={`text-rws-gray relative bg-white rounded-lg shadow-lg p-8 mx-4 z-10 h-fit w-[95dvw] lg:w-[40dvw] transform transition-all duration-500 ease-in-out ${
        ...
        {!success ? (
          <>
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center">
                  <div className="flex flex-row justify-center items-center mx-auto px-4 lg:px-0">
                    <img
                      src="/images/logos/RWSLogoBlue.png"
                      alt=""
                      className="w-16 lg:w-20"
                    ></img>
                    <p>&nbsp;&nbsp;Rusty's Web Services</p>
                  </div>
                  <p className="text-sm text-rws-gray font-normal opacity-60">
            ...
            {loading ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-2 lg:space-y-4">
                {/* Form Fields */}
                <div>
                  <label htmlFor="request-type" className="block text-gray-700">
                    Request Type *
                  </label>
                  <select
                    id="request-type"
                  ...
                  >
                    ...
                    <option value="web-development-small">
                      Web Development (Small)
                    </option>
                    <option value="web-development-large">
                      Web Development (Large)
                    </option>
                    <option value="plugin-development">
                      Plugin Development
                    </option>
                    <option value="standalone-project">
                      Standalone Project
                    </option>
                ...
                <div>
                  <label htmlFor="contact-info" className="block text-gray-700">
                ...
                <div className="flex justify-end">
                  <button
                    type="button"
                    className="bg-rws-gray opacity-50 text-rws-smoke py-2 px-4 rounded-lg hover:bg-gray-500 transition-all duration-200 mr-4"
                    onClick={handleClose}
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="bg-rws-dark-blue text-rws-smoke py-2 px-4 rounded-lg hover:bg-rws-dark-blue-hover transition-all duration-200"
                  >
                    Submit
                  </button>
                </div>
          ...
          <div className="text-center">
            ...
            <p className="text-black text-md">
              Your ticket ID:{" "}
              <span className="font-bold text-rws-dark-blue">{ticketId}</span>
              ...
              <br />
              If your details were correct, you will receive an Email within 24
              hours confirming your request details. If you don't receive a
              confirmation in that time, contact us stating your issue and
              ticket ID.
            </p>
            ...
            <p className="text-rws-gray text-sm mt-1.5">
              {isCopied ? "" : "Click the copy button to copy your ticket ID"}
            </p>
          </div>
        )}
      </div>
