    ...
    <div className="container mx-auto px-4 py-8 w-[95dvw] lg:w-[75dvw]">
      ...
      <section className="mb-8 border border-rws-dark-blue px-6 py-3 rounded-3xl">
        ...
        <p className="text-lg mb-4">
          Welcome to Rusty's Web Services. By using this website, you agree to
        ...
        <p className="text-lg mb-4">
          ...
          enjoyment of this website. Unauthorized use of the website may give
          rise to a claim for damages and/or be a criminal offense.
        </p>
        <div id="dp"></div>
        <p className="text-lg">
          Rusty's Web Services reserves the right to update or modify these
      ...
      <section className="mb-8 border border-rws-dark-blue px-6 py-3 rounded-3xl">
        ...
        <p className="text-lg">
          ...
          personal information at any time. For further inquiries, please
          contact us at{" "}
          <a
            href="mailto:contact@rustyws.com"
            target="_blank"
            rel="noopener noreferrer"
            className="text-rws-dark-blue hover:text-rws-dark-blue-hover hover:underline"
          >
            contact@rustyws.com
          </a>
          .
      ...
      <section className="mb-8 border border-rws-dark-blue px-6 py-3 rounded-3xl">
        ...
        <p className="text-lg mb-4">
          ...
          name and email address when you use our services. This information is
          used solely for providing our services, responding to your inquiries,
      ...
      <section className="mb-8 border border-rws-dark-blue px-6 py-3 rounded-3xl">
        ...
        <p className="text-lg mb-4">
          This website is operated by Rusty's Web Services. We strive to provide
          accurate and up-to-date information; however, we make no
        ...
        <p className="text-lg mb-4">
          By accessing this website, you acknowledge and agree that you do so at
          your own risk. Rusty's Web Services shall not be liable for any
          direct, indirect, or consequential loss or damage arising from the use
          of this website.
        </p>
        <div id="cn"></div>
        <p className="text-lg">
      ...
      <section className="mb-8 border border-rws-dark-blue px-6 py-3 rounded-3xl">
        ...
        <p className="text-lg mb-4">
          Rusty's Web Services (RWS) © 2024 - present. All rights reserved. All
          content, including but not limited to text, graphics, images, and
          code, is the property of Rusty's Web Services unless otherwise stated.
          All designs are developed by an internal website designer unless
          stated otherwise.
        </p>
        <p className="text-lg mb-4">
          Unauthorised reproduction, distribution, or use of the materials on
          this website without prior written permission is strictly prohibited.
        </p>
        <p className="text-lg">
          If you would like to use any content for non-commercial or educational
          purposes, please contact us for appropriate permissions.
        </p>
      </section>
    </div>
  );
