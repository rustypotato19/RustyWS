...
const ViewTicketPage = () => {
  ...
  return (
    <div className="container mx-auto p-8 h-[74.9dvh]">
      ...
      <div className="flex flex-row">
        ...
        <button onClick={handleSearch} className="bg-rws-dark-blue hover:bg-rws-dark-blue-hover text-white px-4 py-2 rounded-lg mb-4 ml-2">
          Search
        </button>
      </div>
      {loading && <p>Loading...</p>}
