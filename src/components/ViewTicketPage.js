...
const ViewTicketPage = () => {
  ...
  return (
    <section className="mx-auto w-full h-full flex justify-center items-center">
      <div className="mx-auto p-2 lg:p-8 h-[74.9dvh] w-full lg:w-[80dvw]">
        ...
        {ticketData && (
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p>
              <strong>Contact Info:</strong> {ticketData.contact_info}
            </p>
            <p>
