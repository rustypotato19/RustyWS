...
const Footer = () => {
  return (
    <footer id="contact" className="flex items-center justify-center bg-rws-gray text-white py-4 text-center rounded-t-[50px] w-full">
      <div className="container mx-4 w-[80dvw] md:mx-2">
        <p className="w-5/6 text-center mx-auto">
          ...
          <br />
          Icons by: <a className="text-blue-400 opacity-80 hover:text-blue-500 hover:underline" href="https://icons8.com">icons8.com</a>
        </p>
