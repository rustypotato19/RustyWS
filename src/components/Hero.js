...
const Hero = () => {
  ...
  return (
    <section className="mx-auto my-6 lg:my-12 w-full h-[70dvh] lg:h-[60dvh] flex justify-center items-center text-rws-dark-blue">
      <div className="w-[90dvw] lg:w-[60dvw] h-full bg-rws-smoke flex flex-col lg:flex-row justify-center items-center rounded-[75px] lg:rounded-[175px]">
        <div className="w-3/4 lg:w-[60%] h-[95%] lg:h-[75%] flex flex-col items-center justify-center lg:ml-12 border-rws-dark-blue border-b-2 lg:border-b-0 lg:border-r-2">
          <h1 className="w-full h-full text-xl sm:text-2xl lg:text-3xl font-extrabold text-center mt-16 lg:mt-10">
            ...
            {isSmallWidth ? (
              isSmallHeight ? (
                <p className="font-semibold text-md lg:text-lg">
                  Not quite sure? <a href="#more">Read More</a>
                </p>
              ) : (
                <p className="font-semibold text-md lg:text-lg">
          ...
          <div className="w-[60%] h-full flex flex-col gap-4 justify-center items-center">
            ...
            <div>
              <a
                ...
                className="text-rws-smoke mx-auto py-1 px-2 lg:py-3 lg:px-3 rounded-2xl bg-rws-dark-blue transition-all duration-200 hover:scale-105 hover:shadow-slate-400 hover:shadow-md"
              >Find Your Ticket</a>
            </div>
          </div>
          {isSmallWidth ? (
            ...
            <div className="w-2/3 h-0 text-transparent lg:border-y-[1px] border-rws-dark-blue">.</div>
          )}
          
          <div className="w-[45%] h-full flex flex-col gap-4 justify-center items-center">
            <h2 className="text-md lg:text-xl font-bold">
              {isSmallWidth ? "Need Help?" : (<p>Need help or more <br/>information?</p>)}
            </h2>
            <div>
              <a
